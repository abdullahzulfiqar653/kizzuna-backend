...
class TestInsightTagView(APITestCase):
    def setUp(self) -> None:
        ...
        self.takeaway1 = Takeaway.objects.create(title='takeaway 1 in insight', note=self.note, created_by=self.user)
        self.tag1 = Tag.objects.create(name='tag 1 in takeaway 1')
        self.tag2 = Tag.objects.create(name='tag 2 in takeaway 1')
        ...
        self.tag3 = Tag.objects.create(name='tag 3 in takeaway 2')
