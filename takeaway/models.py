...
class Takeaway(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='created_takeaways', related_query_name='created_takeaways')
    upvoted_by = models.ManyToManyField(User, related_name='upvoted_takeaways', related_query_name='upvoted_takeaways')
