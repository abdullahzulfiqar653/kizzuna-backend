...
GOOGLE_VERIFICATION_CLIENT_SECRET_FILE = env(
    "GOOGLE_VERIFICATION_CLIENT_SECRET_FILE", default=GOOGLE_CLIENT_SECRET_FILE
)
GOOGLE_VERIFICATION_CLIENT_SECRET_JSON = env(
    "GOOGLE_VERIFICATION_CLIENT_SECRET_JSON", default=None
)
if GOOGLE_VERIFICATION_CLIENT_SECRET_JSON and not os.path.exists(
    GOOGLE_VERIFICATION_CLIENT_SECRET_FILE
):
    os.makedirs(os.path.dirname(GOOGLE_VERIFICATION_CLIENT_SECRET_FILE), exist_ok=True)
    with open(GOOGLE_VERIFICATION_CLIENT_SECRET_FILE, "w") as f:
        json.dump(json.loads(GOOGLE_VERIFICATION_CLIENT_SECRET_JSON), f)
