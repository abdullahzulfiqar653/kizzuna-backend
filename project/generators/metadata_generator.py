...
map_prompt = ChatPromptTemplate.from_messages(
    [
        ('system', 'You are a skilled professional known for exceptional ability to summarize texts.'),
...
class MetadataSchema(BaseModel):
    title: str = Field(description='Title of the meeting. Should be concise but informative.')
    description: str = Field(description='A short paragraph describing what the meeting is about.')
...
reduce_chain = create_structured_output_chain(MetadataSchema.schema(), llm, reduce_prompt)
