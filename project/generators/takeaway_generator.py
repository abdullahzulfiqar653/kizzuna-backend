...
class TakeawaySchema(BaseModel):
    ...
    title: str = Field(description='What the takeaway is about. This should be an important message, issue, learning point or pain point of the text.')
...
prompt = ChatPromptTemplate.from_messages(
    [
        ('system', 'You are an experienced product analyst. You are experienced in identifying pain points and takeaways from user interviews.'),
        ('human', 'Identify Important Takeaways/Issues/Learning Points in the below given text and reasons why they are important.\n\n{text}'),
    ]
)
takeaways_chain = create_structured_output_chain(TakeawaysSchema.schema(), llm, prompt, verbose=True)
